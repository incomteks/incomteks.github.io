...
$rwl=round(($game_day+1000)/500)*$coef/4;
$rtw=round(($game_day+1000)/750)*$coef/4;
$rtn=round(($game_day+1000)/100)*$coef/4;
$rfr=round(($game_day+1000)/50)*$coef/4;
$rlf=round(($game_day+1000)/6)*$coef/4;
$rhf=round(($game_day+1000)/12)*$coef/4;
$rdv=round(($game_day+1000)/1000)*$coef/4;
